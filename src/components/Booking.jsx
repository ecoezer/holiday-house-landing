            ...
            <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'center' }}>
                <div className="reveal-left">
                    ...
                    <div style={{ marginBottom: '1.5rem' }}>
                        ...
                        <p><strong>Email:</strong> info@ferienhaus-spanien.com</p>
                    </div>
                </div>

                <form className="glass-card reveal-right" style={{ backgroundColor: '#fff', padding: '2.5rem', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' }} onSubmit={(e) => e.preventDefault()}>
                    <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    <button className="btn btn-primary hover-lift" style={{ width: '100%', padding: '1rem' }}>Send Inquiry</button>
                </form>
            </div>
        </section>
    );
